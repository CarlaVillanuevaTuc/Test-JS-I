...
function redondearNumero(num) {
  ...
  // Tu código:
  //Este método funciona para redondear un número dependiendo de su parte decimal.
  // Si su parte decimal es mayor o igual a 5, se redondea hacia arriba. Si no, se redondea hacia abajo.
